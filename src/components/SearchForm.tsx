        ...
        >
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="London, UK" {...field} className="bg-white rounded-xl" />
                            </FormControl>
                        </FormItem>
                    )} 
                />
                                ...
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        <Button
                                            ...
                                            variant={"outline"}
                                            className={cn(
                                                "w-full lg:w-[300px] justify-start text-left font-normal bg-white rounded-xl hover:bg-white",
            ...
            <div className="flex w-full items-center space-x-2">
                    ...
                    <FormField
                        ...
                        render={({field}) => 
                            <FormItem className="flex flex-col">
                                ...
                                <FormMessage />
                                <FormControl>
                                    <Input type="number" placeholder="Adults" {...field} className="bg-white rounded-xl" />
                                </FormControl>
                            </FormItem>
                        }
                    />
                    ...
                    <FormField
                        ...
                        render={({field}) => 
                            <FormItem className="flex flex-col">
                                ...
                                <FormMessage />
                                <FormControl>
                                    <Input type="number" placeholder="Children" {...field} className="bg-white rounded-xl" />
                                </FormControl>
                            </FormItem>
                        }
                    />
                    ...
                    <FormField
                        ...
                        render={({field}) => 
                            <FormItem className="flex flex-col">
                                ...
                                <FormMessage />
                                <FormControl>
                                    <Input type="number" placeholder="Rooms" {...field} className="bg-white rounded-xl" />
                                </FormControl>
                            </FormItem>
                        }
                    />
                ...
                <div className="mt-auto">
                    <Button type="submit" className="bg-blue-500 text-base rounded-xl hover:bg-blue">
                        Search
                    </Button>
                </div>
            </div>
